...
class Material(models.Model):
    ...
    gramage = models.DecimalField(max_digits=5, decimal_places=2, null=True, blank=True)
    ...
    def __str__(self):
        return f'{self.categoria} {self.nombre} {self.ancho}cm x {self.alto}cm {self.gramage}gr  {self.color} ${self.precio}'
